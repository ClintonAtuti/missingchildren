...
if (isset($_POST['btnupdate'])) {
	...
	//prepare an update
	$sql_update="UPDATE `missingchild`.`system_admin` SET `First_Name` = '".$fname."', `Middle_Name` = '".$mname."', `Last_Name` = '".$lname."', `Email_address` = '".$email."', `Mobile_No` = '".$mobile."', `Postal_Address` = '".$postaladd."' WHERE `system_admin`.`UserID` = 'Clinton Atuti' ";
