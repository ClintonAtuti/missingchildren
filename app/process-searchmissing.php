...
if (isset($_POST['btnsubmitsearch'])) {
	...
	if($num_rows==0){
		header("refresh:3;url=../views/displaymissingchild.php");
...
<!--start of html to display the missing child with a default image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      <a href="../views/missingchilddetail.php?id=<?php echo $id?>"><img src="../storage/img/default.jpg" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
...
<!--start of html to display the missing child with an image image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
    <div class="container">
      <a href="../views/missingchilddetail.php?id=<?php echo $id?>"><img src="../storage/img/<?php echo $img;?>" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
        <p><strong style="color: green;">AGE:</strong> <?php echo $age;?></p>
