...
if(isset($_POST['CREATE'])){
	...
	$sql_checkid="SELECT * FROM `registry` WHERE `National_ID`='".$nationalid."'";
	...
	$sql="INSERT INTO `missingchild`.`user` (`Username`, `Password`,`National_ID`, `Role`, `Email`, `Status`, `Organisation`, `Location`) VALUES (?, ?, ?, ?, ?, '1',?,?)";
	//prepare statement
