...
<!--start of header bar -->
  ...
  <div class="row">
    <div class="page-header">
          <a href="../views/familyMember/familyMemberdashboard.php" style="text-decoration: none;color: rgb(51,51,51);"><h1>Kenyan Missing</h1></a>
          <span class="icon-bar">
...
if (isset($_POST['btnsubmitsearch'])) {
  ...
  $sql="SELECT `ID`,`Full_Name`,`Image`,`Age`,`Height`,`Weight`,`Gender`,`SkinColor`,`HairColor`,`EyeColor`,`Description`,`Date_Reported`,`Reporter_ID` FROM lostandfoundWHERE `Full_Name` LIKE  '%".$fullname."%'";
  $query_run=mysqli_query($conn,$sql);
  $num_rows=mysqli_num_rows($query_run);
  if($num_rows==0){
    header("refresh:3;url=../views/familyMember/displaylostandfound.php");
    ...
    while ($row=mysqli_fetch_assoc($query_run)) {
      ...
      elseif ($numrows==0) {
        ...
        elseif ($numrowsuser==0) {
          //check if the reporter is in familyMember table
          $sqlfamilyMemberdetail="SELECT `First_Name`,`Last_Name`,`Phone_No` FROM familyMember WHERE ID_No='".$reporter_id."'";
          $query_runfamilyMember=mysqli_query($conn,$sqlfamilyMemberdetail);
          $numrowfamilyMember=mysqli_num_rows($query_runfamilyMember);
          if ($numrowfamilyMember==1) {
            while ($rowfamilyMember=mysqli_fetch_assoc($query_runfamilyMember)) {
              $fname=$rowfamilyMember['First_Name'];
              $lname=$rowfamilyMember['Last_Name'];
              $mobo=$rowfamilyMember['Phone_No'];
            }//end of while loop
          }//end of while loop
        }
      ...
      if($img==""){
        ?>
<!--start of html to display the missing child with a default image with name,age,last seen and county-->
         <!-- Wrapper for slides -->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      <a href="../views/familyMember/lostandfounddetail.php?id=<?php echo $id?>"><img src="../storage/img/default.jpg" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
...
<!--end of html to display the missing child with a default image-->
                <?php
          ...
          ?>
<!--start of html to display the missing child with an image image with name,age,last seen and county-->
         <!-- Wrapper for slides -->
  <div class="carousel-inner" role="listbox">
    <div class="item active">
    <div class="container">
      <a href="../views/familyMember/lostandfounddetail.php?id=<?php echo $id?>"><img src="../storage/img/<?php echo $img;?>" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
        <p><strong style="color: green;">AGE:</strong> <?php echo $age;?></p>
...
<!--end of html to display the missing child with a default image-->
        ...
        }//end of if the missing child has an image
