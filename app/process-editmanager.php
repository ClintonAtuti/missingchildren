...
if (isset($_POST['btnupdate'])) {
	...
	//prepare an update
	$sql_update="UPDATE `missingchild`.`user` SET `First_Name` = '".$fname."', `Middle_Name` = '".$mname."', `Last_Name` = '".$lname."', `Email` = '".$email."', `Phone_No` = '".$mobile."' WHERE `user`.`Username` = '".$_SESSION['Authorised']."' ";
