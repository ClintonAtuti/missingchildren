...
<!--start of stylish search box body-->
      <div class="container">
  <div class="row">
  <form method="POST" action="../app/process-searchblockedfamilyMember.php">
  <div class="container">
  <h2 style="color: red;"><b>Blocked familyMembers</b></h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
        <h4><?php 
        $sqltotaluser="SELECT COUNT(*) AS Deactivated_familyMember FROM familyMember WHERE `Status`='0' ";
        $sqlrun=mysqli_query($conn,$sqltotaluser);
        while ($rowcount=mysqli_fetch_assoc($sqlrun)) {
            $totaldfamilyMember=$rowcount['Deactivated_familyMember'];
        }
        ?>
        <a href="viewfamilyMember.php" style="text-decoration: none;">View Active familyMembers</a>
        <p>Total Blocked familyMembers: <b style="color: red;"><?php echo $totaldfamilyMember;?></b></p>
    ...
    <tbody>
    <?php 
        $sqlgetuser="SELECT `Username`,`First_Name`,`Last_Name`,`Email`,`Phone_No` FROM familyMember WHERE `Status`='0' ORDER BY `First_Name` ";
