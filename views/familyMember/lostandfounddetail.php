...
if($num_row==1){
    ...
    $sqlgetadminid="SELECT `ID_No` FROM familyMember WHERE `Username`='".$_SESSION['familyMember']."' ";
    ...
    <h3><?php echo $fullname;?></h3>
        ...
        <?php
        }//end of if missing child has an image
		?>
  <form action="../../app/process-familyMemberreunite.php" method="POST">
