...
<div class="container">
    ...
    <div class="col-md-4">
		<div class="form_main">
                <h4 class="heading" style="color:red;"><strong>Report </strong> Missing child <span></span></h4>
                <div class="form">
               <form action="../../app/process-reportmissingchildbyfamilyMember.php" method="post" id="contactFrm" name="contactFrm" enctype="multipart/form-data">
