...
$pdf->cell(20,18,"",0);
$pdf->cell(150,10,'Missingchild App',0);
$pdf->SetFont('Arial','',9);
$pdf->cell(50,10,'Date: '.date('d-m-Y').'',0);
$pdf->Ln(15);
$pdf->SetFont('Arial','B',11);
$pdf->cell(70,8,'',0);
$pdf->cell(100,8,'LOST AND FOUND child REPORT',0);
$pdf->Ln(15);
...
$pdf->cell(25,8,'Date Reported',0);
$pdf->Ln(8);
$pdf->SetFont('Arial','',8);

$missing=mysqli_query($conn,"SELECT * FROM lostandfoundWHERE (`Date_Reported` BETWEEN '".$startdate."' AND '".$enddate."') ORDER BY Full_Name");
$sno=0;
...
<div class="container">
    ...
    <div class="col-md-4">
		<div class="form_main">
                <h4 class="heading" style="color:red;"><strong>Generate </strong> Lost and Found Report <span></span></h4>
