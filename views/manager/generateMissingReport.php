...
$pdf->cell(70,8,'',0);
$pdf->cell(100,8,'MISSING child REPORT',0);
$pdf->Ln(15);
...
$missing=mysqli_query($conn,"SELECT * FROM missing WHERE (`Date_Reported` BETWEEN '".$startdate."' AND '".$enddate."') ORDER BY Full_Name");
$sno=0;
...
<div class="container">
    ...
    <div class="col-md-4">
		<div class="form_main">
                <h4 class="heading" style="color:red;"><strong>Generate </strong> Missing Report <span></span></h4>
