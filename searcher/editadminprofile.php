...
//retrieve the current admin details
  $sql="SELECT `First_Name`,`Middle_Name`,`Last_Name`,`Email`,`Phone_No` FROM familyMember WHERE `Username`='".$_SESSION['familyMember']."'";
...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form class="form-horizontal" action="../../app/process-editfamilyMember.php" method="post">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-8">
   ...
   <input type="submit" name="btnupdate"  id="btnupdate" class="btn btn-success" value="Update Profile">
    <input type="button" class="btn btn-danger" value="Cancel" onClick="window.location='familyMemberdashboard.php';">
  </div>
</div>
      ...
      <form id="tab2" action="../../app/process-changefamilyMemberpassword.php" method="post">
