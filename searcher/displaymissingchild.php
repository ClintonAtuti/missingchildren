        ...
        <div class="container">
              <div class="pull-right">
                <ul class="nav pull-right">
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome, <?php echo $_SESSION['familyMember'];?> <b class="caret"></b></a>
...
<!--start of header bar -->
	...
	<div class="row">
		<div class="page-header">
         <a href="familyMemberdashboard.php" style="text-decoration: none;color: rgb(51,51,51);"> <h1>Kenyan Missing</h1></a>
          <span class="icon-bar">
...
<!--start of stylish search box body-->
      <div class="container">
  <div class="row">
  <form method="POST" action="../../app/process-searchmissingbyfamilyMember.php">
  <div class="container">
  <h2 style="color: red;"><b>Missing child</b></h2>
...
<!--start of html to display the missing child with a default image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      ...
      <a href="missingchilddetail.php?id=<?php echo $id?>"><img src="../../../storage/img/default.jpg" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
...
<!--start of html to display the missing child with an image image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      ...
      <a href="missingchilddetail.php?id=<?php echo $id?>"><img src="../../storage/img/<?php echo $img;?>" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
        <p><strong style="color: green;">AGE:</strong> <?php echo $age;?></p>
