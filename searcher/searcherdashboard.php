...
//echo "Welcome familyMember".$_SESSION['familyMembername'];
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-md-4">
            ...
            <div id="sidebar" class="well sidebar-nav">
                ...
                <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="#">MISSING child</a></li>
                    <li><a href="reportmissingchild.php">Add Missing child</a></li>
                    <li><a href="displaymissingchild.php">Search Missing child</a></li>
